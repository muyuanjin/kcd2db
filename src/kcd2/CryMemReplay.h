...
#endif
{
	...
	//! Records an event against the currently active scope and exits it.
	void ExitScope_Alloc(unsigned __int64 id, unsigned __int64 sz, unsigned __int64 alignment = 0)                                {}
	void ExitScope_Realloc(unsigned __int64 originalId, unsigned __int64 newId, unsigned __int64 sz, unsigned __int64 alignment = 0)      {}
	void ExitScope_Free(unsigned __int64 id)                                                                      {}
	void ExitScope()                                                                                      {}

	bool EnterLockScope()                                                                                 { return false; }
	void LeaveLockScope()                                                                                 {}

	void AllocUsage(EMemReplayAllocClass::Class allocClass, unsigned __int64 id, unsigned __int64 used)                   {}
